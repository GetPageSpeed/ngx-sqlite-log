...
# In this test, we test the buffer flush timer at 3s.
...
# Set up
my $total_tests = 28;
my $conf = Util::read_file("conf/sqlitelog_buffer_flush.conf");
...
# Confirm that buffer was flushed
is($count, 3, "Check if table had 3 records after waiting flush duration");
