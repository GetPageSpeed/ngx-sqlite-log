...
# Here, we test the sqlitelog_async directive with default settings.
...
# Set up
my $total_tests = 18;
my $conf = Util::read_file("conf/sqlitelog_async_off.conf");
my $t = Test::Nginx->new()->has(qw/http rewrite threads/)->plan($total_tests)->write_file_expand('nginx.conf', $conf);
